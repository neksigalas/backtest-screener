"""
State management for New Tactic 3 Best Stocks Paper Trading.
Improved entry signals vs original paper_trader — same exit rules (TP/SL ±10%).
"""
...
SCORE_THRESHOLD  = 70     # lower threshold because entry signals are stricter
